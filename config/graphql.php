...
return [
    'route' => [
        ...
        'controller' =>\App\Http\Controllers\TestController::class . '@query',
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                ...
                \App\GraphQL\Mutations\RegisterUser::class
...
//                \App\Http\Middleware\Login::class,
             \App\GraphQL\Middleware\LoginCheck::class
...
//                \App\GraphQL\Middleware\LoginCheck::class
    ...
    'types' => [
        ...
        \App\GraphQL\Types\UserType::class,
        \App\GraphQL\Types\LoginUser::class,
        \App\GraphQL\Types\RegisterUser::class,
...
//    'error_formatter' => [Rebing\GraphQL\GraphQL::class, 'formatError'],
    'error_formatter' => [\App\Exceptions\GraphQlError::class, 'formatError'],
...
//    'errors_handler' => [Rebing\GraphQL\GraphQL::class, 'handleErrors'],
    'errors_handler' => [\App\Exceptions\GraphQlError::class, 'handleErrors'],
